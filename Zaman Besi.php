      ...
      <section class="py-5">
        ...
        <div class="container px-5 mb-5">
            <div class="text-center mb-5">
                <h1 class="display-5 fw-bolder mb-0"><span class="badge bg-gradient-primary-to-secondary text-white mb-4">Zaman Besi</span></h1>
            </div>
            ...
            <img class="profile-img" src="assets/zaman-besi.jpg" alt="..." />
            </div>
        </div>
        </div>
        </div>
                            ...
                            <div class="row align-items-center gx-5">
                                <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                    <div class="bg-light p-4 rounded-4">
                                        <div class="text-primary fw-bolder mb-2">Tahun</div>
                                        <div class="small fw-bolder">Zaman Besi</div>
                                        <div class="small text-muted">materi</div>
                                        <div class="small text-muted">materi</div>
                                    </div>
                                </div>
                                <div class="col-lg-8"><div>materi</div></div>
                            </div>
                        </div>
                    </div>
